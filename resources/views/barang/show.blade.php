			  	...
			  	<form action="{{ route('barang.show',$barang->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('kode') ? ' has-error' : '' }}">
			  			...
			  			<input type="number" name="kode" class="form-control" value="{{ $barang->kode }}" readonly>
			  			@if ($errors->has('kode'))
			  		...
			  		<div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" value="{{ $barang->nama }}" name="nama" class="form-control"  readonly>
			  			@if ($errors->has('nama'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('hargajual') ? ' has-error' : '' }}">
			  			...
			  			<input type="number" name="hargajual" class="form-control" value="{{ $barang->hargajual }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('hargabeli') ? ' has-error' : '' }}">
			  			...
			  			<input type="number" name="hargabeli" class="form-control" value="{{ $barang->hargabeli }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('id_penyalur') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="id_penyalur" class="form-control" value="{{ $barang->Penyalur->nama }}" readonly>
